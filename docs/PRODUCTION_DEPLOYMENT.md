...
- **epicprod-live publisher**: `swf-epicprod-live.service` — tails the epicprod action stream and posts live events to `#epicprod-live` as the `epicprod` bot account (`EPICPROD_LIVE_TOKEN` in production.env; see ACTION_STREAM.md)
