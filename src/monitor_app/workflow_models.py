...
class WorkflowStatus(models.TextChoices):
    ...
    PROC_RECEIVED = "proc_received", "Received by Processing Agent"
    PROC_PROCESSING = "proc_processing", "Processing Agent Processing"
    PROC_COMPLETE = "proc_complete", "Processing Agent Complete"
